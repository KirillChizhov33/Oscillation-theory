function duffing_poincare_fixed_points_nox_fmt
% Поиск фикс-точек Poincaré (t=0, T=2π) и их мультипликаторов
...
fprintf('%3s  %10s %10s   %12s          %26s        %15s   %s\n', ...
        '#','x','y','||P(z)-z||','eigs(λ1, λ2)','|λ1|, |λ2|','Type');
